...
namespace Ams.Core
{
    public class APP
    {
        ...
        //BLL的一些设置
        public static string SERVICE_BLL_NAMESPACE = "Ams.Models"; //指定bll层的命名空间
        public static string SERVICE_BLL_FILE_NAME = "Ams.Web"; //指定bll层所在的dll名称，如Ams.BLL.dll 则值为Ams.BLL
        ...
        //数据库的一些设置
        public static string DB_DEFAULT_CONN_NAME = "Sys";//ConfigurationManager.ConnectionStrings[1].Name;
