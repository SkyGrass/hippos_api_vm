...
using IPAddressPatternConvert = log4net.Layout.Pattern.IPAddressPatternConvert;
...
namespace log4net.Layout
{
    ...
    public class PatternLayout : LayoutSkeleton
    {
        ...
        /// </para>
        /// </remarks>
        public const string DetailConversionPattern = "%timestamp [%thread] [%identity] [%ipaddress] %level %logger %ndc - %message%newline";
        ...
        static PatternLayout()
        {
            ...
            s_globalRulesRegistry.Add("i", typeof(IPAddressPatternConvert));
            s_globalRulesRegistry.Add("ipaddress", typeof(IPAddressPatternConvert));
        }
