...
using Ams.Utils.ZipLib.Encryption;
#endif

using Ams.Utils.ZipLib.Core;
using Ams.Utils.ZipLib.Checksums;
using Ams.Utils.ZipLib.Zip.Compression.Streams;
using Ams.Utils.ZipLib.Zip.Compression;

namespace Ams.Utils.ZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Ams.Utils.ZipLib.Zip.ZipException">
