...
namespace Ams.Utils.Ionic.Zip
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </para>
        /// </remarks>
        public Ams.Utils.Ionic.Zip.ExtractExistingFileAction ExtractExistingFile
        {
            get;
            set;
        }
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "Ams.Utils.Ionic.Zip.WinFormsSelfExtractorStub.resources",
                    "Ams.Utils.Ionic.Zip.Forms.PasswordDialog.resources",
                    "Ams.Utils.Ionic.Zip.Forms.ZipContentsDialog.resources"},
        ...
        //         "namespace Ams.Utils.Ionic.Zip { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorSaveOptions options)
        {
            ...
            try
            {
                ...
                // get the Ams.Utils.Ionic.Zip assembly
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider())
                {
                    ...
                    // This is the list of referenced assemblies.  Ams.Utils.Ionic.Zip is
                    ...
                    using (ZipFile zip = ZipFile.Read(a2.GetManifestResourceStream("Ams.Utils.Ionic.Zip.Resources.ZippedResources.zip")))
                    {
                        ...
                        {
                            // Use the ico file that is embedded into the Ams.Utils.Ionic.Zip
                        ...
                        // add the Ams.Utils.Ionic.Utils.Zip DLL as an embedded resource
