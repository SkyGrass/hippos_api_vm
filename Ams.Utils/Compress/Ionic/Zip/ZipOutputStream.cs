...
// generating zip files.  This class does not depend on Ams.Utils.Ionic.Zip.ZipFile, but rather
...
namespace Ams.Utils.Ionic.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = Ams.Utils.Ionic.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="Ams.Utils.Ionic.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = Ams.Utils.Ionic.Zip.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="Ams.Utils.Ionic.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private Ams.Utils.Ionic.Crc.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public Ams.Utils.Ionic.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
