...
namespace Ams.Utils.Ionic.Zip
{
    ...
    public enum ZipEntrySource
    {
        ...
        /// <summary>
        /// The entry was instantiated via <see cref="Ams.Utils.Ionic.Zip.ZipFile.AddEntry(string,string)"/> or
        /// <see cref="Ams.Utils.Ionic.Zip.ZipFile.AddEntry(string,System.IO.Stream)"/> .
        /// </summary>
        Stream,
        ...
        /// The entry was instantiated via <see cref="Ams.Utils.Ionic.Zip.ZipFile.AddEntry(string,OpenDelegate,CloseDelegate)"/>.
        /// </summary>
        JitStream,
