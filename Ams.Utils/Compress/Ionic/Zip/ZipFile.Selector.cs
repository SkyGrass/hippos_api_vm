...
namespace Ams.Utils.Ionic.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            Ams.Utils.Ionic.FileSelector ff = new Ams.Utils.Ionic.FileSelector(selectionCriteria,
...
namespace Ams.Utils.Ionic
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(Ams.Utils.Ionic.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(Ams.Utils.Ionic.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(Ams.Utils.Ionic.Zip.ZipEntry entry)
        {
        ...
        public ICollection<Ams.Utils.Ionic.Zip.ZipEntry> SelectEntries(Ams.Utils.Ionic.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<Ams.Utils.Ionic.Zip.ZipEntry>();

            foreach (Ams.Utils.Ionic.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<Ams.Utils.Ionic.Zip.ZipEntry> SelectEntries(Ams.Utils.Ionic.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
