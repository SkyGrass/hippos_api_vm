...
namespace Ams.Utils.Ionic.Zip
{
    ...
    public partial class ZipFile
    {
        ...
        ///
        /// <exception cref="Ams.Utils.Ionic.Zip.BadStateException">
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = new Ams.Utils.Ionic.Zip.ZipFile())
        /// {
        ///     zip.CompressionLevel= Ams.Utils.Ionic.Zlib.CompressionLevel.BestCompression;
        ...
        /// {
        ///   using (var zip = Ams.Utils.Ionic.Zip.ZipFile.Read(inputStream))
        ///   {
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = Ams.Utils.Ionic.Zip.ZipFile.Read(filename))
        /// {
        ///     zip.AddEntry("Name1.txt", "this is the content");
        ///     zip.Save();  // YES!
        /// }
