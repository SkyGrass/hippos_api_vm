...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:Ams.Utils.Ionic.BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace Ams.Utils.Ionic.BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly Ams.Utils.Ionic.Crc.CRC32 crc = new Ams.Utils.Ionic.Crc.CRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new Ams.Utils.Ionic.BZip2.BZip2InputStream(fs))
        ///       {
