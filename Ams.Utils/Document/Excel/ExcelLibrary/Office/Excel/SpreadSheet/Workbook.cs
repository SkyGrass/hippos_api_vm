...
using Ams.Utils.ExcelLibrary.CompoundDocumentFormat;
using Ams.Utils.ExcelLibrary.BinaryFileFormat;
using Ams.Utils.ExcelLibrary.BinaryDrawingFormat;

namespace Ams.Utils.ExcelLibrary.SpreadSheet
{
