...
namespace Ams.Utils.NPOI.SS.Formula
{
    ...
    class OperationEvaluatorFactory
    {
        ...
        private static void Add(Hashtable m, OperationPtg ptgKey,
            Ams.Utils.NPOI.SS.Formula.Functions.Function instance)
        {
                ...
                OperationEvaluationContext ec)
        {
            ...
            Ams.Utils.NPOI.SS.Formula.Functions.Function result = _instancesByPtgClass[ptg] as Ams.Utils.NPOI.SS.Formula.Functions.Function;
            ...
            if (ptg is AbstractFunctionPtg)
            {
                ...
                {
                    case Ams.Utils.NPOI.SS.Formula.Function.FunctionMetadataRegistry.FUNCTION_INDEX_INDIRECT:
                        return Indirect.instance.Evaluate(args, ec);
                    case Ams.Utils.NPOI.SS.Formula.Function.FunctionMetadataRegistry.FUNCTION_INDEX_EXTERNAL:
