...
namespace Ams.Utils.NPOI.SS.UserModel
{
    using System;
    ...
    public interface IRow
    {
        ...
        /// (255 for *.xls, 1048576 for *.xlsx)
        /// </throws>
        ICell CreateCell(int column, Ams.Utils.NPOI.SS.UserModel.CellType type);
        ...
        /// <see cref="GetCell(int, Ams.Utils.NPOI.SS.UserModel.MissingCellPolicy)"/>
        ICell GetCell(int cellnum);

        /// <summary>
        /// Returns the cell at the given (0 based) index, with the specified {@link Ams.Utils.NPOI.SS.usermodel.Row.MissingCellPolicy}
        /// </summary>
