...
namespace Ams.Utils.NPOI.HSSF.Util
{
    using System;
    using System.Collections;
    using Ams.Utils.NPOI.HSSF.UserModel;
    ...
    public class HSSFCellUtil
    {
        ...
        public static Ams.Utils.NPOI.SS.UserModel.IRow GetRow(int rowCounter, HSSFSheet sheet)
        {
            Ams.Utils.NPOI.SS.UserModel.IRow row = sheet.GetRow(rowCounter);
            if (row == null)
            {
        ...
        public static Ams.Utils.NPOI.SS.UserModel.ICell GetCell(Ams.Utils.NPOI.SS.UserModel.IRow row, int column)
        {
            Ams.Utils.NPOI.SS.UserModel.ICell cell = row.GetCell(column);
        ...
        public static Ams.Utils.NPOI.SS.UserModel.ICell CreateCell(Ams.Utils.NPOI.SS.UserModel.IRow row, int column, String value, HSSFCellStyle style)
        {
            Ams.Utils.NPOI.SS.UserModel.ICell cell = GetCell(row, column);
        ...
        /// <param name="value">The value of the cell</param>
        /// <returns>A new HSSFCell.</returns>
        public static Ams.Utils.NPOI.SS.UserModel.ICell CreateCell(Ams.Utils.NPOI.SS.UserModel.IRow row, int column, String value)
        {
         ...
         */
        public static void SetCellStyleProperty(Ams.Utils.NPOI.SS.UserModel.ICell cell, HSSFWorkbook workbook, String propertyName, Object propertyValue)
        {
            Ams.Utils.NPOI.SS.UserModel.ICellStyle originalStyle = cell.CellStyle;
            Ams.Utils.NPOI.SS.UserModel.ICellStyle newStyle = null;
            ...
            {
                Ams.Utils.NPOI.SS.UserModel.ICellStyle wbStyle = workbook.GetCellStyleAt(i);
        ...
        private static Hashtable GetFormatProperties(Ams.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        private static void SetFormatProperties(
                Ams.Utils.NPOI.SS.UserModel.ICellStyle style, HSSFWorkbook workbook, Hashtable properties)
        {
            style.Alignment = (Ams.Utils.NPOI.SS.UserModel.HorizontalAlignment)GetShort(properties, ALIGNMENT);
            style.BorderBottom = (Ams.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_BOTTOM);
            style.BorderLeft = (Ams.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_LEFT);
            style.BorderRight = (Ams.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_RIGHT);
            style.BorderTop = (Ams.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_TOP);
            ...
            style.FillPattern = (Ams.Utils.NPOI.SS.UserModel.FillPatternType)GetShort(properties, FILL_PATTERN);
            ...
            style.VerticalAlignment = (Ams.Utils.NPOI.SS.UserModel.VerticalAlignment)GetShort(properties, VERTICAL_ALIGNMENT);
