...
namespace Ams.Utils.NPOI.HSSF.Record
{
    ...
    public class ArrayRecord : SharedValueRecordBase
    {
        ...
        private Ams.Utils.NPOI.SS.Formula.Formula _formula;
            ...
            : base(in1)
        {
		    ...
		    _formula = Ams.Utils.NPOI.SS.Formula.Formula.Read(formulaTokenLen, in1, totalFormulaLen);
        }
        public ArrayRecord(Ams.Utils.NPOI.SS.Formula.Formula formula, CellRangeAddress8Bit range):base(range)
        {
