...
namespace Ams.Utils.NPOI.HSSF.UserModel
{
    using System;
    using System.Collections;
    using System.Collections.Generic;
    using System.Windows.Forms;
    using Ams.Utils.NPOI.DDF;
    using Ams.Utils.NPOI.HSSF.Model;
    using Ams.Utils.NPOI.HSSF.Record;
    using Ams.Utils.NPOI.HSSF.Record.Aggregates;
    using Ams.Utils.NPOI.HSSF.Record.AutoFilter;
    using Ams.Utils.NPOI.HSSF.Util;
    using Ams.Utils.NPOI.SS;
    using Ams.Utils.NPOI.SS.Formula;
    using Ams.Utils.NPOI.SS.Formula.PTG;
    using Ams.Utils.NPOI.SS.UserModel;
    using Ams.Utils.NPOI.SS.Util;
    ...
    /// </remarks>
    [Serializable]
    public class HSSFSheet : Ams.Utils.NPOI.SS.UserModel.ISheet
    {
        ...
        private Dictionary<int, Ams.Utils.NPOI.SS.UserModel.IRow> rows;
        ...
        /// <see cref="Ams.Utils.NPOI.HSSF.UserModel.HSSFWorkbook.CreateSheet()"/>
        public HSSFSheet(HSSFWorkbook workbook)
        {
            _sheet = InternalSheet.CreateSheet();
            rows = new Dictionary<int, Ams.Utils.NPOI.SS.UserModel.IRow>();
        ...
        /// <see cref="Ams.Utils.NPOI.HSSF.UserModel.HSSFWorkbook(Ams.Utils.NPOI.POIFS.FileSystem.DirectoryNode, bool)"/>
        ...
        public Ams.Utils.NPOI.SS.UserModel.IRow CreateRow(int rownum)
        {
        ...
        private int FindLastRow(int lastrow)
        {
            ...
            Ams.Utils.NPOI.SS.UserModel.IRow r = GetRow(rownum);
        ...
        /// <returns></returns>
        public Ams.Utils.NPOI.SS.UserModel.ICellStyle GetColumnStyle(int column)
        {
        ...
        public Ams.Utils.NPOI.SS.UserModel.IRow GetRow(int rowIndex)
        {
        ...
        [Obsolete]
        public int AddMergedRegion(Ams.Utils.NPOI.SS.Util.Region region)
        {
        ...
        /// <returns>index of this region</returns>
        public int AddMergedRegion(Ams.Utils.NPOI.SS.Util.CellRangeAddress region)
        {
        ...
        //public Ams.Utils.NPOI.SS.Util.Region GetMergedRegionAt(int index)
        //{
        //    Ams.Utils.NPOI.SS.Util.CellRangeAddress cra = GetMergedRegion(index);

        //    return new Ams.Utils.NPOI.SS.Util.Region(cra.FirstRow, (short)cra.FirstColumn,
        ...
        /// Call <see cref="Ams.Utils.NPOI.SS.UserModel.IRow.RowNum"/> on each row 
        ...
        public Ams.Utils.NPOI.SS.UserModel.IPrintSetup PrintSetup
        {
        ...
        public Ams.Utils.NPOI.SS.UserModel.IHeader Header
        {
        ...
        public Ams.Utils.NPOI.SS.UserModel.IFooter Footer
        {
        ...
        public void SetEnclosedBorderOfRegion(CellRangeAddress region, Ams.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderRightOfRegion(CellRangeAddress region, Ams.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetRightBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderRight(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderLeftOfRegion(CellRangeAddress region, Ams.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetLeftBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderLeft(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderTopOfRegion(CellRangeAddress region, Ams.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetTopBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderTop(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderBottomOfRegion(CellRangeAddress region, Ams.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetBottomBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderBottom(borderType, region, this, _workbook);
        }
        ...
        protected void ShiftMerged(int startRow, int endRow, int n, bool IsRow)
        {
            ...
            {
                Ams.Utils.NPOI.SS.Util.CellRangeAddress merged = this.GetMergedRegion(i);
            ...
            {
                Ams.Utils.NPOI.SS.Util.CellRangeAddress region = (Ams.Utils.NPOI.SS.Util.CellRangeAddress)iterator.Current;
        ...
        [Obsolete]
        private static bool ContainsCell(Ams.Utils.NPOI.SS.Util.CellRangeAddress cr, int rowIx, int colIx)
        {
            ...
            bool copyRowHeight, bool resetOriginalRowHeight, bool moveComments)
        {
            ...
            for (int rowNum = s; rowNum >= startRow && rowNum <= endRow && rowNum >= 0 && rowNum < 65536; rowNum += inc)
            {
                ...
                foreach (ICell cell in cells)
                {
                    ...
                    Ams.Utils.NPOI.SS.UserModel.IHyperlink link = cell.Hyperlink;
                    if (link != null)
                    {
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int leftmostColumn, int topRow, Ams.Utils.NPOI.SS.UserModel.PanePosition activePane)
        ...
        // public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, Ams.Utils.NPOI.SS.UserModel.PanePosition activePane)
        {
        ...
        public Ams.Utils.NPOI.SS.Util.PaneInformation PaneInformation
        {
            get
            {
        ...
        public double GetMargin(Ams.Utils.NPOI.SS.UserModel.MarginType margin)
        {
        ...
        public void SetMargin(Ams.Utils.NPOI.SS.UserModel.MarginType margin, double size)
        {
        ...
        public Ams.Utils.NPOI.SS.UserModel.IDrawing CreateDrawingPatriarch()
        {
            if (_patriarch == null)
            {
        ...
        public void SetDefaultColumnStyle(int column, Ams.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        public IComment GetCellComment(int row, int column)
        {
            ...
            if (r != null)
            {
                Ams.Utils.NPOI.SS.UserModel.ICell c = r.GetCell(column);
                if (c != null)
                {
        ...
        /// </summary>
        public Ams.Utils.NPOI.SS.UserModel.IWorkbook Workbook
        {
            get
            {
                return _workbook;
        ...
        public String SheetName
        {
            get
            {
                Ams.Utils.NPOI.SS.UserModel.IWorkbook wb = Workbook;
