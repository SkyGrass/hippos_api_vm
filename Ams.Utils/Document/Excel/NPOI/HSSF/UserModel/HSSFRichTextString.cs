...
namespace Ams.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary> 
    [Serializable]
    public class HSSFRichTextString : IComparable<HSSFRichTextString>,Ams.Utils.NPOI.SS.UserModel.IRichTextString
    {
        ...
        public void ApplyFont(int startIndex, int endIndex, Ams.Utils.NPOI.SS.UserModel.IFont font)
        {
        ...
        public void ApplyFont(Ams.Utils.NPOI.SS.UserModel.IFont font)
        {
