...
namespace Ams.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFName:Ams.Utils.NPOI.SS.UserModel.IName
    {
        ...
        public String RefersToFormula
        {
            ...
            set
            {
                Ptg[] ptgs = HSSFFormulaParser.Parse(value, book, Ams.Utils.NPOI.SS.Formula.FormulaType.NAMEDRANGE, SheetIndex);
