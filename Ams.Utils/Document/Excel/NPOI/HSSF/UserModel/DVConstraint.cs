...
namespace Ams.Utils.NPOI.HSSF.UserModel
{
    ...
    public class DVConstraint : IDataValidationConstraint
    {
         ...
         * 
         * @param validationType one of {@link Ams.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#ANY},
         * {@link Ams.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#DECIMAL},
         * {@link Ams.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#INTEGER},
         * {@link Ams.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#TEXT_LENGTH}
         * @param comparisonOperator any constant from {@link Ams.Utils.NPOI.SS.UserModel.DataValidationConstraint.OperatorType} enum
         ...
         * 
         * @param comparisonOperator constant from {@link Ams.Utils.NPOI.SS.UserModel.DataValidationConstraint.OperatorType} enum
        ...
        /* (non-Javadoc)
         * @see Ams.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getValidationType()
         */
        ...
        /* (non-Javadoc)
         * @see Ams.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getFormula1()
         */
        ...
        /* (non-Javadoc)
         * @see Ams.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getFormula2()
         */
