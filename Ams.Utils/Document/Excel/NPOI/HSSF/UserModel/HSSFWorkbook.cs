...
namespace Ams.Utils.NPOI.HSSF.UserModel
{
    ...
    using Ams.Utils.NPOI.POIFS.FileSystem;
    using Ams.Utils.NPOI.SS.Formula;
    using Ams.Utils.NPOI.SS.Formula.PTG;
    using Ams.Utils.NPOI.SS.Formula.Udf;
    ...
    public class HSSFWorkbook : POIDocument, IWorkbook
    {
        ...
        public Ams.Utils.NPOI.SS.UserModel.ICreationHelper GetCreationHelper()
        {
        ...
        /// </summary>
        private class SheetRecordCollector : Ams.Utils.NPOI.HSSF.Record.Aggregates.RecordVisitor,IDisposable
        {
     ...
     */
        ...
        [NonSerialized]
        private Ams.Utils.NPOI.SS.UserModel.MissingCellPolicy missingCellPolicy = Ams.Utils.NPOI.SS.UserModel.MissingCellPolicy.RETURN_NULL_AND_BLANK;
        /// <summary>
        ...
        public Ams.Utils.NPOI.SS.UserModel.MissingCellPolicy MissingCellPolicy
        {
        ...
        public Ams.Utils.NPOI.SS.UserModel.ISheet GetSheetAt(int index)
        {
        ...
        public Ams.Utils.NPOI.SS.UserModel.ISheet GetSheet(String name)
        {
                                               ...
                                               int startRow, int endRow)
        {
            ...
            Ams.Utils.NPOI.SS.UserModel.IPrintSetup printSetup = sheet.PrintSetup;
        ...
        public Ams.Utils.NPOI.SS.UserModel.IFont CreateFont()
        {
        ...
        //public Ams.Utils.NPOI.SS.UserModel.Font FindFont(Ams.Utils.NPOI.SS.UserModel.FontBoldWeight boldWeight, short color, short fontHeight,
        //                 String name, bool italic, bool strikeout,
        //                 Ams.Utils.NPOI.SS.UserModel.FontSuperScript typeOffset, Ams.Utils.NPOI.SS.UserModel.FontUnderlineType Underline)
        //{
        ...
        /// <returns></returns>
        public Ams.Utils.NPOI.SS.UserModel.IFont FindFont(short boldWeight, short color, short fontHeight,
                         String name, bool italic, bool strikeout,
                         short typeOffset, byte Underline)
        {
            ...
            for (short i = 0; i <= this.NumberOfFonts; i++)
            {
                ...
                Ams.Utils.NPOI.SS.UserModel.IFont hssfFont = GetFontAt(i);
        ...
        public Ams.Utils.NPOI.SS.UserModel.IFont GetFontAt(short idx)
        {
        ...
        public Ams.Utils.NPOI.SS.UserModel.ICellStyle CreateCellStyle()
        {
        ...
        public Ams.Utils.NPOI.SS.UserModel.ICellStyle GetCellStyleAt(short idx)
        {
 ...
 */
        ...
        public Ams.Utils.NPOI.SS.UserModel.IName GetName(String name)
        {
        ...
        public Ams.Utils.NPOI.SS.UserModel.IName GetNameAt(int index)
        {
        ...
        /// </summary>
        /// <returns>named range high level</returns>
        public Ams.Utils.NPOI.SS.UserModel.IName CreateName()
        {
        ...
        public Ams.Utils.NPOI.SS.UserModel.IDataFormat CreateDataFormat()
        {
            if (formatter == null)
        ...
        public int AddPicture(byte[] pictureData, Ams.Utils.NPOI.SS.UserModel.PictureType format)
        {
            InitDrawings();
            ...
            switch (format)
            {
                case Ams.Utils.NPOI.SS.UserModel.PictureType.EMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_EMF;
                    break;
                case Ams.Utils.NPOI.SS.UserModel.PictureType.WMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_WMF;
                    break;
                case Ams.Utils.NPOI.SS.UserModel.PictureType.PICT:
                    blipRecord.Options = HSSFPictureData.MSOBI_PICT;
                    break;
                case Ams.Utils.NPOI.SS.UserModel.PictureType.PNG:
                    blipRecord.Options = HSSFPictureData.MSOBI_PNG;
                    break;
                case Ams.Utils.NPOI.SS.UserModel.PictureType.JPEG:
                    blipRecord.Options = HSSFPictureData.MSOBI_JPEG;
                    break;
                case Ams.Utils.NPOI.SS.UserModel.PictureType.DIB:
