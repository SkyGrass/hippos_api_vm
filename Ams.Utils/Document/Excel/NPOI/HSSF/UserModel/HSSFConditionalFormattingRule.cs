...
namespace Ams.Utils.NPOI.HSSF.UserModel
{
    ...
    using Ams.Utils.NPOI.HSSF.Record.CF;
        ...
        public String Formula2
        {
            get
            {
                ...
                if (conditionType == CELL_COMPARISON)
                {
                    ...
                    {
                        case (byte)Ams.Utils.NPOI.SS.UserModel.ComparisonOperator.BETWEEN:
                        case (byte)Ams.Utils.NPOI.SS.UserModel.ComparisonOperator.NOT_BETWEEN:
