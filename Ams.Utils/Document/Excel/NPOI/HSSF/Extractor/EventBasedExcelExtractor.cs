...
namespace Ams.Utils.NPOI.HSSF.Extractor
{
    using System;
    using System.Text;
    using System.IO;
    ...
    using Ams.Utils.NPOI;
    using Ams.Utils.NPOI.HPSF;
    using Ams.Utils.NPOI.SS.Formula.Eval;
    using Ams.Utils.NPOI.HSSF.EventUserModel;
    ...
    public class EventBasedExcelExtractor : POIOLE2TextExtractor
    {
        ...
        private class TextListener : HSSFListener
        {
            ...
            private String FormatNumberDateCell(CellValueRecordInterface cell, double value)
            {
                ...
                {
                    // Is it a date?
                    if (Ams.Utils.NPOI.SS.UserModel.DateUtil.IsADateFormat(formatIndex, formatString) &&
                            Ams.Utils.NPOI.SS.UserModel.DateUtil.IsValidExcelDate(value))
                    {
                        ...
                        // Format as a date
                        DateTime d = Ams.Utils.NPOI.SS.UserModel.DateUtil.GetJavaDate(value, false);
