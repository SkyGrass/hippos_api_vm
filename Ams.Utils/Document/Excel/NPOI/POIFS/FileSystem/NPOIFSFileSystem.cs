...
using System.IO;
using Ams.Utils.NPOI.POIFS.Common;
using Ams.Utils.NPOI.POIFS.Dev;
using Ams.Utils.NPOI.POIFS.NIO;
using Ams.Utils.NPOI.POIFS.Properties;
using Ams.Utils.NPOI.POIFS.Storage;
using Ams.Utils.NPOI.Util;
using Ams.Utils.NPOI.POIFS.EventFileSystem;

namespace Ams.Utils.NPOI.POIFS.FileSystem
{
