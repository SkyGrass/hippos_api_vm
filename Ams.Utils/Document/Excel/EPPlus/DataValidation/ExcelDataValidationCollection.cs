...
using Ams.Utils.EPPlus.Utils;
using System.Xml;
using Ams.Utils.EPPlus.DataValidation.Contracts;

namespace Ams.Utils.EPPlus.DataValidation
{
    /// <summary>
    /// <para>
    ...
    public class ExcelDataValidationCollection : XmlHelper, IEnumerable<IExcelDataValidation>
    {
        ...
        public bool Remove(IExcelDataValidation item)
        {
            ...
            {
                throw new InvalidCastException("The supplied item must inherit Ams.Utils.EPPlus.DataValidation.ExcelDataValidation");
            }
