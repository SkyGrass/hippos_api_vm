...
namespace Ams.Utils.EPPlus.Style
{
    ...
    public abstract class StyleBase
    {
        ...
        internal Ams.Utils.EPPlus.XmlHelper.ChangedEventHandler _ChangedEvent;
        protected int _positionID;
        protected string _address;
        internal StyleBase(ExcelStyles styles, Ams.Utils.EPPlus.XmlHelper.ChangedEventHandler ChangedEvent, int PositionID, string Address)
        {
            _styles = styles;
